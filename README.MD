...
Task: I had to refactor the following PHP code using modern PHP solutions. In my solution, I aimed to adhere to clean code principles, with a special focus on SOLID principles. 
